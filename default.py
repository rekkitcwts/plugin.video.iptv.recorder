...
formatstr1 = "%s %s" % (dateshort_format, time_format.replace(':%S', ''))
# log((date,dateshort_format,time_format,formatstr1))
start_time = datetime.datetime.fromtimestamp(time.mktime(time.strptime(date, formatstr1)))
